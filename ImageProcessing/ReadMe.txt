...
应用程序向导已为您创建了此 ImageProcessing 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
ImageProcessing.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CImageProcessingApp 应用程序类。

ImageProcessing.cpp
    这是包含应用程序类 CImageProcessingApp 的主应用程序源文件。
...
res\ImageProcessing.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 ImageProcessing.rc 中。
...
ImageProcessingDoc.h、ImageProcessingDoc.cpp - 文档
    这些文件包含 CImageProcessingDoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CImageProcessingDoc::Serialize）。

ImageProcessingView.h、ImageProcessingView.cpp - 文档视图
